...
function createBenchmark( shape ) {
	...
	z = filled5dBy( shape, uniform( -100.0, 100.0 ) );
	w = filled5dBy( shape, uniform( -100.0, 100.0 ) );
	out = zeros5d( shape );
	...
	*/
	function benchmark( b ) {
		...
		i1 = i % shape[ 3 ];
		i0 = i % shape[ 4 ];
		if ( isnan( arrays[ 4 ][ i4 ][ i3 ][ i2 ][ i1 ][ i0 ] ) ) {
			b.fail( 'should not return NaN' );
		}
