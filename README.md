...
```javascript
quaternary5d = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/array-base-quaternary5d@v0.2.2-umd/browser.js' )
```
...
[test-image]: https://github.com/stdlib-js/array-base-quaternary5d/actions/workflows/test.yml/badge.svg?branch=v0.2.2
[test-url]: https://github.com/stdlib-js/array-base-quaternary5d/actions/workflows/test.yml?query=branch:v0.2.2
